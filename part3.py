...
PRODUCTS = [
    {
        ...
        "name": "100 قالب CV احترافي",
        "short": "حزمة 100 قالب سيرة ذاتية بتصميمات متنوعة تناسب كل المجالات.",
        "details": "100 قالب Word جاهز للتعديل، تصميمات متنوعة بين الكلاسيكي والعصري، يناسب مختلف المجالات والمستويات الوظيفية.",
        "price": "150 ج.م",
        "keywords": "قوالب CV, قوالب سيرة ذاتية جاهزة, تحميل قوالب CV Word",
    },
    {
        "slug": "ats-resume-templates",
        "name": "قوالب CV متوافقة مع ATS",
        "short": "قوالب مُختبرة تمر بسلاسة عبر أنظمة الفرز الآلي.",
        "details": "مجموعة مختارة من القوالب المُختبرة على أنظمة ATS الشائعة، بتنسيق نظيف بدون جداول أو عناصر تُربك أنظمة الفرز.",
        "price": "120 ج.م",
    ...
    },
    {
        ...
        "short": "أكثر أسئلة المقابلات شيوعًا مع طريقة إجابة نموذجية.",
        "details": "ملف PDF يغطي أكثر أسئلة المقابلات الشخصية والسلوكية شيوعًا، مع أمثلة إجابات وطريقة تركيب إجابتك بنفسك.",
        "price": "90 ج.م",
    ...
    },
    {
        ...
        "short": "خطوات عملية لبناء ملف LinkedIn يجذب الفرص.",
        "details": "دليل رقمي يشرح خطوة بخطوة كيفية كتابة العنوان والملخص واختيار الكلمات المفتاحية وبناء شبكة علاقات مهنية فعالة.",
        "price": "100 ج.م",
        "keywords": "دليل لينكدإن, LinkedIn guide عربي, تحسين بروفايل لينكدإن",
    },
    {
        "slug": "career-planner-template",
        "name": "مخطط التطور المهني",
        "short": "قالب تخطيط يساعدك تحدد أهدافك المهنية للسنة القادمة.",
        "details": "قالب قابل للتعديل يساعدك تحلل وضعك الحالي، تحدد أهدافك المهنية، وتضع خطة عملية زمنية للوصول لها.",
        "price": "80 ج.م",
        "keywords": "مخطط مهني, career planner, خطة تطوير مهني",
    },
    {
        "slug": "ats-keywords-pack",
        "name": "حزمة كلمات ATS المفتاحية",
        "short": "قوائم كلمات مفتاحية جاهزة لأكثر من 15 مجال وظيفي.",
        "details": "قوائم كلمات مفتاحية منظمة حسب المجال (هندسة، محاسبة، تسويق، برمجة وغيرها) تساعدك تدمجها في سيرتك الذاتية بذكاء.",
        "price": "70 ج.م",
...
for p in PRODUCTS:
    ...
    schema = ('[' + ORG_SCHEMA + ',' +
        '{"@context":"https://schema.org","@type":"Product","name":"%s","description":"%s","offers":{"@type":"Offer","priceCurrency":"EGP","price":"%s","availability":"https://schema.org/InStock"}}' % (
            p["name"], p["short"], p["price"].replace(" ج.م", "")) + ']')
    body = product_body(p, 1)
    html = page(
        depth=1, active="store",
        title=f"{p['name']} | متجر WORKLIXEG الرقمي",
        description=p["short"],
        keywords=p["keywords"],
        canonical=canonical,
        h1_breadcrumb=p["name"],
        breadcrumb_items=[("المتجر", "index.html"), (p["name"], None)],
        body=body,
        extra_schema=schema,
    )
...
store_hub_body = hero_simple(
    "المتجر الرقمي", "قوالب وأدلة رقمية جاهزة للتحميل الفوري",
    "منتجات رقمية مصممة باحتراف لتوفر وقتك: قوالب CV متوافقة مع ATS، أدلة مقابلات، وحزم كلمات مفتاحية جاهزة."
)
...
write("store/index.html", page(
    depth=1, active="store",
    title="متجر WORKLIXEG الرقمي | قوالب CV وأدلة توظيف جاهزة للتحميل",
    description="تصفح متجر WORKLIXEG الرقمي: قوالب سيرة ذاتية متوافقة مع ATS، أدلة مقابلات، دليل LinkedIn، وحزم كلمات مفتاحية جاهزة للتحميل الفوري.",
    keywords="متجر رقمي, قوالب CV, أدلة توظيف, منتجات رقمية للتوظيف, قوالب سيرة ذاتية للتحميل",
    canonical=f"{SITE_URL}/store/index.html",
    h1_breadcrumb="المتجر",
    breadcrumb_items=[("المتجر", None)],
    body=store_hub_body,
